...
plt.plot(x, y, 'go-', linewidth=2.0, markersize=8, markeredgewidth=2, markeredgecolor='g', markerfacecolor='None', label = "General solid theory")
plt.plot(x1D1, y1D1, 'bx--', linewidth=2.0, markersize=8, markeredgewidth=2, markeredgecolor='b', markerfacecolor='None', label = "Mindlin-Reissner plate theory")
plt.plot(x1D2, y1D2, 'rv:', linewidth=2.0, markersize=8, markeredgewidth=2, markeredgecolor='r', markerfacecolor='None', label = "Second order shell theory")
plt.xlabel(r"$h/L$")
